      ...
      <div class="modal-body profile_box_padding">
      	...
      	<div>
			  ...
			  <ul class="nav nav-tabs" role="tablist">
			    <li role="presentation" class="active"><a href="#basic_information" aria-controls="home" role="tab" data-toggle="tab" class="tab_name">General</a></li>
			    ...
			    <li role="presentation"><a href="#hotel_transport_information" aria-controls="home" role="tab" data-toggle="tab" class="tab_name">Hotel & Transport Information</a></li>
			    <?php } ?>
			    <li role="presentation"><a href="#booking_costing" aria-controls="home" role="tab" data-toggle="tab" class="tab_name">Costing Information</a></li>
