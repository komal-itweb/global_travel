...
public function quotation_master_save()
{
	...
	$q = "insert into car_rental_quotation_master ( quotation_id, enquiry_id, login_id,emp_id, branch_admin_id,financial_year_id, customer_name,email_id,mobile_no, total_pax,days_of_traveling,traveling_date,travel_type,places_to_visit,vehicle_name,from_date,to_date,route,extra_km_cost,extra_hr_cost,daily_km,subtotal,markup_cost,markup_cost_subtotal,taxation_id,service_charge,service_tax_subtotal,permit,toll_parking,driver_allowance,total_tour_cost,created_at,quotation_date,total_hrs,total_km,rate,total_max_km,total_mini_km,state_entry,other_charge,night_halt,capacity,local_places_to_visit,bsm_values,roundoff) values ('$quotation_id','$enquiry_id','$login_id','$emp_id', '$branch_admin_id','$financial_year_id', '$customer_name','$email_id','$mobile_no', '$total_pax','$days_of_traveling','$traveling_date','$travel_type','$places_to_visit','$vehicle_name','$from_date','$to_date','','$extra_km_cost','$extra_hr_cost','$daily_km','$subtotal','$markup_cost','$markup_cost_subtotal','$taxation_id','$service_charge','$service_tax_subtotal','$permit','$toll_parking','$driver_allowance','$total_tour_cost','$created_at','$quotation_date','$total_hr','$total_km','$rate','$total_max_km','$total_mini_km','$state_entry','$other_charge','$night_halt','$capacity','$local_places_to_visit','$bsmValues','$roundoff')";
...
*Duration* : '.$sq_quotation['days_of_traveling'].' Days
*Cost* : Outstation minimum '.$sq_quotation['total_mini_km'].'km per day chargable '.$currency.$sq_quotation['rate'].'
Night Halt per night :'.$currency.$sq_quotation['night_halt'].'
Driver allowance :'.$currency.$sq_quotation['driver_allowance'].' 
Toll parking and GST extra
');
	}
	$whatsapp_msg .='
