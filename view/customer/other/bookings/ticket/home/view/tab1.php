		...
		<div class="profile_box main_block">
			<h3>Booking Details</h3>
			  ...
			  <div class="col-sm-6 col-xs-12">
				<span class="main_block">
					<i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
					<?php echo "<label>Adults <em>:</em></label> ".$sq_ticket['adults'];?>
				</span>
				<span class="main_block">
					<i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
					<?php echo "<label>Children <em>:</em></label> ".$sq_ticket['childrens'];?>
				</span>
				<span class="main_block">
					<i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
					<?php echo "<label>Infants <em>:</em></label> ".$sq_ticket['infant'];?>
				</span>	
			  </div>	
			  </div>		
		</div>	
	        ...
	        <div class="panel panel-default panel-body app_panel_style">
	        	<div class="row">
		            ...
		            <div class="col-md-3 col-sm-6 col-xs-12 right_border_none_sm" style="border-right: 1px solid #ddd">
					    ...
					    <span class="main_block">
		                  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		                  <?php echo "<label>YQ Markup Cost <em>:</em></label> ".$sq_ticket['yq_tax_markup']; ?>
		                </span>		                
					 </div>
					 <div class="col-md-3 col-sm-6 col-xs-12 right_border_none_sm_xs" style="border-right: 1px solid #ddd">
		        	    <span class="main_block">
		        	      <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		        	      <?php echo "<label>YQ Discount <em>:</em></label> ".$sq_ticket['yq_tax_discount']; ?>
		        	    </span>
		        	    <span class="main_block">
		        	      <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		        	      <?php echo "<label>G1 + F2 Tax <em>:</em></label> ".$sq_ticket['g1_plus_f2_tax']; ?> 
		        	    </span>
		        		<span class="main_block">
		        		  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		            	...
		            	<span class="main_block">
		                  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		                  <?php echo "<label>".get_tax_name()."(%) <em>:</em></label> ".$sq_ticket['service_tax']; ?>
		                </span>		        		
		            </div>
		            <div class="col-md-3 col-sm-6 col-xs-12 right_border_none_sm_xs">
		                <span class="main_block">
		                  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
		                  <?php echo "<label>".get_tax_name()." Amount <em>:</em></label> ".$sq_ticket['service_tax_subtotal']; ?>
		                </span>
		                <span class="main_block">
		                  <i class="fa fa-angle-double-right cost_arrow" aria-hidden="true"></i>
