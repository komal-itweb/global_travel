    ...
    <div class="modal-content">
        ...
        <div class="panel panel-default panel-body app_panel_style feildset-panel">
          <legend>Personal Information</legend>
            ...
            <div class="row">
              ...
              <input type="text" id="booking_type1" name="booking_type1" placeholder="Booking Type" title="Booking Type" value="<?= $sq_booking['booking_type'] ?>" >
      ...
      <div class="panel panel-default panel-body app_panel_style feildset-panel mg_tp_30">
        ...
        <div class="row">
          ...
          <textarea class="form-control" id="other_comment1" name="other_comment1" placeholder="Other Comments" title="Other Comments"><?= $sq_booking['other_comment'] ?></textarea>
          </div>
        </div>
        </div>
...
$(function(){
  $('#frm_hotel_booking_update').validate({
    ...
    submitHandler:function(form){
      ...
      var other_comment = $('#other_comment1').val();
