...
public function fetch_email_id_from_system()
{
	...
	while($row_group_tour = mysql_fetch_assoc($sq_group_tour)){
		...
		$sq_email_count = mysql_num_rows(mysql_query("select * from sms_email_id where email_id='$row_group_tour[email_id]'"));
		...
		if($sq_email_count==0){
			...
			$sq_email_id = mysql_query("insert into sms_email_id ( email_id_id,branch_admin_id, email_id, created_at ) values ( '$email_id_id', '$branch_admin_id', '$row_group_tour[email_id]', '$created_at' )");
			if(!$sq_email_id){
	...
	while($row_package_tour = mysql_fetch_assoc($sq_package_tour)){
		...
		$sq_email_count = mysql_num_rows(mysql_query("select * from sms_email_id where email_id='$row_package_tour[email_id]'"));
		...
		if($sq_email_count==0){
			...
			$sq_mobile_no = mysql_query("insert into sms_email_id (  email_id_id, branch_admin_id, email_id, created_at ) values ('$email_id_id', '$branch_admin_id', '$row_package_tour[email_id]', '$created_at' )");
			if(!$sq_mobile_no){
				echo "Email ID  saved successfully!";
				exit;
			}
	...
	while($row_customer = mysql_fetch_assoc($sq_customer)){
		...
		$sq_email_count = mysql_num_rows(mysql_query("select * from sms_email_id where email_id='$row_customer[email_id]'"));
		...
		if($sq_email_count==0){
			...
			$sq_email_id = mysql_query("insert into sms_email_id (email_id_id, branch_admin_id, email_id, created_at ) values ('$email_id_id', '$branch_admin_id', '$row_customer[email_id]', '$created_at' )");
			if(!$sq_email_id){
				echo "Email ID saved successfully!";
				exit;
			}
