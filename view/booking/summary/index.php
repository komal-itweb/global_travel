...
function list_reflect()
{
	...
	$.post(base_url+'view/booking/summary/list_reflect.php', { customer_id : customer_id, id : id, from_date : from_date, to_date : to_date, cust_type : cust_type, company_name : company_name,booker_id:booker_id,branch_id : branch_id , branch_status : branch_status}, function(data){
...
function excel_report()
{
	...
	var base_url = $('#base_url').val();
	 var branch_status = $('#branch_status').val();
	window.location = base_url+'view/booking/summary/excel_report.php?customer_id='+customer_id+'&id='+id+'&from_date='+from_date+'&to_date='+to_date+'&cust_type='+cust_type+'&company_name='+company_name+'&booker_id='+booker_id+'&branch_id='+branch_id+'&branch_status='+branch_status;
}
...
function dynamic_customer_load(cust_type, company_name)
{
  ...
  var base_url = $('#base_url').val();
   var branch_status = $('#branch_status').val();
    $.get(base_url+"view/booking/inc/get_customer_dropdown.php", { cust_type : cust_type , company_name : company_name, branch_status : branch_status}, function(data){
...
{  
    ...
    var base_url = $('#base_url').val();
    var branch_status = $('#branch_status').val();
  	$.post(base_url+'view/booking/company_name_load.php', { cust_type : cust_type , branch_status : branch_status}, function(data){
