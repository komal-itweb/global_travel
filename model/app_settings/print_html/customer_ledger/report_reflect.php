...
<!-- header -->
    ...
    <!-- print-detail -->
		...
		<table class="table table-bordered cust_table" id="tbl_list" style="padding: 0 !important; background: #fff;">
			...
			<thead>
				...
				<tr class="table-heading-row">
					...
					<th>Invoice_ID</th>
					<th>Date</th>
					<th class="text-right info">Booking_Amount</th>
			...
			while($row_booking = mysql_fetch_assoc($sq_booking)){
				$sale_total_amount=$row_booking['actual_tour_expense'] + $row_booking['total_travel_expense'];
		...
		{
			$sale_total_amount=$row1['total_travel_expense'] + $row1['total_tour_fee'];
				if($sale_total_amount==""){  $sale_total_amount = 0 ;  }
...
<th colspan="3" class="text-right info">Total Amount : <?= number_format($total_amount,2) ?></th>

<th colspan="2" class="text-right success">Total Paid : <?= number_format($total_paid,2) ?></th>

<th class="text-right danger">Total Cancel : <?= ($total_cancel=='')?number_format(0,2): number_format($total_cancel,2); ?></th>

<th colspan="2" class="text-right warning">Total Balance : <?= number_format($total_balance,2);?></th>
