                      ...
                      <div class="col-md-12">
                        ...
                        <div class="col-md-12 mg_tp_10">
                          <h5>b) How would you rate your accomodations for Hygiene & Cleanliness?</h5>
                             <div class="col-md-12">
                             <input type="radio" id="yes1" name="hotel_clean" value="Yes"><label class="feedback_option_lable" for="yes1">Yes</label>
                                <input type="radio" id="no1" name="hotel_clean" value="No"><label class="feedback_option_lable" for="no1">No</label>
                            </div>
                        </div>
  ...
  submitHandler:function(){
      ...
      var booking_id = $('#booking_id').val();
        ...
        var sales_team = $('input[name="sales_team"]:checked').val();
         ...
         if (!$('input[name="hotel_clean"]').is(':checked')) {
