...
class quotation_email_send
{
	public function quotation_email(){
		...
		$url1 = "'.BASE_URL.'model/package_tour/quotation/car_rental/quotation_email_template.php?quotation_id='.$quotation_id.'";
		...
		$sq_quotation = mysql_fetch_assoc(mysql_query("select * from car_rental_quotation_master where quotation_id='$quotation_id_arr[0]'"));
		...
		<tr>
			<table width="85%" cellspacing="0" cellpadding="5" style="color: #888888;border: 1px solid #888888;margin: 0px auto;margin-top:20px; min-width: 100%;" role="presentation">
				<tr><td style="text-align:left;border: 1px solid #888888;width:30%">Route</td>   <td style="text-align:left;border: 1px solid #888888;">'.$route.'</td></tr>
				<tr><td style="text-align:left;border: 1px solid #888888;width:30%">Total Days</td>   <td style="text-align:left;border: 1px solid #888888;">'.$sq_quotation['days_of_traveling'].'</td></tr>
				...
				<tr><td style="text-align:left;border: 1px solid #888888;width:30%">View Quotation</td>   <td style="text-align:left;border: 1px solid #888888;width:30%"><a style="color: '.$theme_color.';text-decoration: none;" href="'.BASE_URL.'model/package_tour/quotation/car_rental/single_quotation.php?quotation='.$quotation_no.'">View</a></td></tr>
			</table>
		</tr>	';
		}
		$content .= '
		...
		$subject = 'New Quotation : (Car Rental)';
