...
$objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('D'.$row_count, "From Bank")
        ->setCellValue('E'.$row_count, "To Bank")
...
header('Content-Disposition: attachment;filename="Bank_Transfer('.date('d-m-Y H:i:s').').xls"');
