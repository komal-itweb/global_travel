...
<div class="sidebar_inner main_block"> 
        <div id="cssmenu" style="width:100%"> 
            <ul>            	
               ...
               <!--  <li><a href='<?php echo BASE_URL ?>view/customer/other/enquiry/index.php'><i class="fa fa-comments-o"></i><span>&nbsp;&nbsp;Enquiry</span></a></li>     -->               
                <li><a href='<?php echo BASE_URL ?>view/customer/other/fourth_coming_attractions/fourth_coming_attractions.php'><span><i class="fa fa-newspaper-o"></i>&nbsp;&nbsp;Forth Coming Attractions</span></a></li>
