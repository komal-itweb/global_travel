				...
				<tr>
					...
					<?php
						if($values['preffered_airline'] != ''){
							$sq_airline_show = mysql_fetch_assoc(mysql_query("SELECT airline_name from airline_master where airline_id = ".$values['preffered_airline']));
							
							echo '<option value="'.$values['preffered_airline'].'">'.$sq_airline_show['airline_name'].'</option>';
						}
					?>
