		...
		<div class="widget_parent-bg-img bg-img-red">
			<?php     
	            ...
	            begin_widget();
	                ...
	                $content_arr = array( $sq_train_ticket_info['basic_fair'] , $sq_train_ticket_info['service_charge'],$sq_train_ticket_info['delivery_charges'], $sq_train_ticket_info['service_tax_subtotal'],$sq_train_ticket_info['roundoff'],$sq_train_ticket_info['net_total']);
