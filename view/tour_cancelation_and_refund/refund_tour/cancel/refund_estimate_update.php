...
$query1 = "SELECT * from payment_master where tourwise_traveler_id='$tourwise_id' AND payment_for='Tour'";
...
$query = "SELECT * from payment_master where tourwise_traveler_id='$tourwise_id' AND payment_for='Travelling'";
