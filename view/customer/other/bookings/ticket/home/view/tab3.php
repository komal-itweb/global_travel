<?php 
 //Sale
 $sale_total_amount=$sq_visa_info['ticket_total_cost'];
	    ...
	    <div class="table-responsive">
	        ...
	        <table class="table table-hover table-bordered no-marg" id="tbl_payment_list">
				...
				<tbody>
					...
					$query = "select * from ticket_payment_master where ticket_id='$ticket_id'";		
					...
					while($row_ticket_payment = mysql_fetch_assoc($sq_ticket_payment)){
...

						{
							...
							<tr class="<?= $bg?>">				
								...
								<td class="text-right"><?= $row_ticket_payment['payment_amount'] ?></td>
