...
$query .= " order by booking_id desc";
		...
		while($row_booking = mysql_fetch_assoc($sq_booking)){
			...
			$service_voucher='';
			$service_voucher='<button data-toggle="tooltip" title="Download Service Voucher" class="btn btn-info btn-sm" onclick="voucher_display('.$row_booking['booking_id'] .')" title="Update Details"><i class="fa fa-print"></i></button>';
