    ...
    <div class="container">
        ...
        <div class="app_panel_content Filter-panel mg_bt_20">
            <div class="row mg_bt_10">
                ...
                <div class="col-md-2 col-sm-6 col-xs-12">
                    <select name="taxation_id" id="taxation_id" title="Tax(%)" data-toggle="tooltip" onchange="generic_tax_reflect(this.id, 'service_tax', '');" required><?php get_taxation_dropdown(); ?>
                    </select>
