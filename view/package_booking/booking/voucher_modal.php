		...
		$('#frm_service_voucher').validate({
			...
			submitHandler:function(form, event){
					...
					$.ajax({
						...
						data:{ booking_id : booking_id,vehicle_name_array:vehicle_name_array,driver_name_array : driver_name_array,driver_contact_array : driver_contact_array, special_arrangments : special_arrangments, confirm_by : confirm_by, inclusions : inclusions  },
