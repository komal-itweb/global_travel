...
<table class="table table-bordered bg_white cust_table" id="ticket_list" style="margin:20px 0 !important">
	<thead>
		<tr class="table-heading-row">
			...
			<th class="danger text-right">Cancellation Charges</th>
	...
	<tbody>
		...
		while($row_ticket = mysql_fetch_assoc($sq_ticket)){
			...
			<tr>
				...
				<td>
					<button class="btn btn-info btn-sm" onclick="package_view_modal(<?= $row_ticket['ticket_id'] ?>)" title="View Detail"><i class="fa fa-eye" aria-hidden="true"></i></button>
				</td>
