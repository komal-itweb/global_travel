...
$objPHPExcel->setActiveSheetIndex(0)
                ...
                ->setCellValue('O'.$row_count, "Credit card charges")
...
$count = 0;
        ...
        $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('O'.$row_count, number_format($credit_card_charges,2))
            ->setCellValue('P'.$row_count, number_format($total_sale+$credit_card_charges,2))
            ->setCellValue('Q'.$row_count, number_format($cancel_amount,2))
            ->setCellValue('R'.$row_count, number_format($total_bal,2))
            ->setCellValue('S'.$row_count, number_format($paid_amount,2))
            ->setCellValue('T'.$row_count, number_format($bal,2))
            ->setCellValue('U'.$row_count, get_date_user($row_ticket['payment_due_date']))
        ...
        ->setCellValue('S'.$row_count, 'TOTAL PAID : '.number_format($paid_total,2))
        ->setCellValue('T'.$row_count, 'TOTAL BALANCE :'.number_format($balance_total,2));
