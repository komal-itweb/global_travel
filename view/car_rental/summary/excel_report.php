...
$row_count =11;
        ...
        $objPHPExcel->setActiveSheetIndex(0)
                ...
                ->setCellValue('Y'.$row_count, "Enquiry_no")           
                ->setCellValue('Z'.$row_count, "Enquiry_Date");
    	...
    	$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('Y'.$row_count, get_enquiry_id($row_car['enquiry_id']))
            ->setCellValue('Z'.$row_count, get_date_user($row_car['enquiry_date']));
