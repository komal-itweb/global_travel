          ...
          <div class="row">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
              <input type="text" id="total_mini_km1" name="total_mini_km1" placeholder="Total Mini Km" title="Total Mini Km"  class="form-control" value="<?= $sq_enq_info['total_mini_km'] ?>">
          </div>
            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <legend>Costing Details</legend>
              <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                  <input type="text" id="night_halt1" name="night_halt1" class="text-right form-control" placeholder="Night Halt" title="Night Halt" onchange="calculate_total_fees(this.id,'1');validate_balance(this.id)" value="<?= $sq_enq_info['night_halt'] ?>">
                </div>
              </div>
              <?php
...
$('#from_date1,#to_date1,#total_hrs1,#total_km1,#total_max_km1,#total_mini_km1,#driver_allowance1,#permit_charges1,#toll_and_parking1,#state_entry_tax1,#other_charges1,#local_places_to_visit1,#places_to_visit1,#traveling_date1').hide();
...
function reflect_feilds(){
	...
	if(type=='Local'){
		...
		$('#total_max_km1,#total_mini_km1,#driver_allowance1,#permit_charges1,#toll_and_parking1,#state_entry_tax1,#other_charges1,#places_to_visit1,#traveling_date1').hide();
	}
	if(type=='Outstation'){
		$('#from_date1,#to_date1,#total_hrs1,#total_km1,#local_places_to_visit1').hide();
		$('#total_max_km1,#total_mini_km1,#driver_allowance1,#permit_charges1,#toll_and_parking1,#state_entry_tax1,#other_charges1,#places_to_visit1,#traveling_date1').show();
	}
} reflect_feilds();
$(function(){
  $('#frm_booking_update').validate({
      ...
      submitHandler:function(form){
              ...
              var total_mini_km = $('#total_mini_km1').val();
              ...
              var night_halt = $('#night_halt1').val();
