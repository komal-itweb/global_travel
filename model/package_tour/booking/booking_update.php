...
function package_tour_booking_master_update()
{
    ...
    if(!$sq_booking){
      ...
      $this->package_tour_traveling_information_update( $booking_id, $train_travel_date, $train_from_location, $train_to_location, $train_train_no, $train_travel_class, $train_travel_priority, $train_amount, $train_seats, $train_id, $plane_travel_date, $from_city_id_arr, $plane_from_location, $to_city_id_arr, $plane_to_location, $plane_amount, $plane_seats, $plane_company, $plane_id, $arrval_arr,$cruise_dept_date_arr, $cruise_arrival_date_arr, $route_arr, $cabin_arr, $sharing_arr, $cruise_seats_arr, $cruise_amount_arr,$cruise_id_arr,$plane_checked_programe_arr);
...
///////////////////////////////////***** Package Tour Traveling Information Update start *********/////////////////////////////////////////////////////////////
 function package_tour_traveling_information_update( $booking_id, $train_travel_date, $train_from_location, $train_to_location, $train_train_no, $train_travel_class, $train_travel_priority, $train_amount, $train_seats, $train_id, $plane_travel_date, $from_city_id_arr, $plane_from_location, $to_city_id_arr, $plane_to_location, $plane_amount, $plane_seats, $plane_company, $plane_id, $arrval_arr, $cruise_dept_date_arr, $cruise_arrival_date_arr, $route_arr, $cabin_arr, $sharing_arr, $cruise_seats_arr, $cruise_amount_arr,$cruise_id_arr,$plane_checked_programe_arr)
 {
      ...
      for($i=0; $i<sizeof($plane_travel_date); $i++)
      {
        ...
        if($plane_checked_programe_arr[$i]=="true")
				{
         ...
         // echo $plane_id[$i];
            $query = "Delete from package_plane_master where plane_id = '$plane_id[$i]' and booking_id = '$booking_id'";
