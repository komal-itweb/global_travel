...
include '../../layouts/header_guest.php';
      ...
      <!-- ***** Tours Listing ***** -->
        ...
        while(($row_query  = mysql_fetch_assoc($sq_query))){
            ...
            while($row_trans = mysql_fetch_assoc($sq_trans)){
              $sq_vehicle = mysql_fetch_assoc(mysql_query("select bus_id,bus_name from b2b_transfer_master where entry_id = '$row_trans[vehicle_name]'"));
