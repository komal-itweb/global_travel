<form id="frm_tab1">
	...
	<div class="row">
	<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	      <input type="text" id="total_mini_km" name="total_mini_km"  placeholder="Total Mini Km" title="Total Mini Km" onchange=";validate_balance(this.id)">
	    </div>
		<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
...
$('#total_hr,#total_km,#total_max_km,#total_mini_km,#driver_allowance,#permit_charges,#toll_parking,#state_entry,#other_charges,#night_halt,#places_to_visit,#traveling_date').hide();
