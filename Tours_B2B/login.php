...
global $currency;
$sq_curr = mysql_fetch_assoc(mysql_query("select id from currency_name_master where id='$currency'"));
?>
<!DOCTYPE html>
    ...
    <div class="c-loginContainer">
      ...
      <div class="login_modal">
        ...
        <div class="login_form">
          ...
          <span class="login_subheading">Dicover a competitive pricing</span>
          <!-- **** Headings :: End **** -->
        ...
        if(data1[0]=="valid"){
          ...
          if (typeof Storage !== 'undefined') {
            if (localStorage) {
              ...
              var cart_list_arr = (data1[1] == "") ? [] : JSON.parse(data1[1]);
