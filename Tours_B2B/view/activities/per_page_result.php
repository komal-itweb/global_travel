...
$activity_result_array= $_POST['data'];
          ...
          <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item">
              <a class="nav-link" id="incl-tab" data-toggle="tab" href="#incl<?= $activity_result_array[$i]['exc_id']?>" role="tab"
                aria-controls="incl" aria-selected="true">Inclusions</a>
            </li>
            <li class="nav-item">
            ...
            for($ti=0;$ti<sizeof($activity_result_array[$i]['transfer_options']);$ti++){
                ...
                if($activity_result_array[$i]['transfer_options'][$ti]['offer_type'] != ''){
                    if($activity_result_array[$i]['transfer_options'][$ti]['offer_in'] == 'Percentage')
                        ...
                        $text = '';
                    $room_cost1 = $room_cost + $activity_result_array[$i]['transfer_options'][$ti]['offer_applied'];
                ...
                array_push($original_costs_array,$room_cost1);
            ...
            <script>
                setTimeout(function(){                
                    ...
                    if('<?= $offer_text ?>' != ''){
                        ...
                        document.getElementById("offer-currency-id<?= $activity_result_array[$i]['exc_id'] ?>").innerHTML= '<?= $h_currency_id ?>';
                ...
                <div class="c-cardListTable type-2" role="button">
                  ...
                  <label class="cardList-info" for="<?= $activity_result_array[$i]['exc_id'].$ti ?>" role="button">
                    <div class="flexGrid">
                      ...
                      <?php if($room_cost1 != 0 && $room_cost1 != $room_cost){ ?>
                      <div class="gridItem">
                        <div class="infoCard m0">
                          <div class="M-infoCard">
                            ...
                            <div class="infoCard_price strike">
                              <span class="p_currency currency-icon"></span>
                              <span class="p_cost activity-orgcurrency-price"><?= $room_cost1 ?></span>
