...
$sq_app = mysql_fetch_assoc(mysql_query("select * from app_settings where setting_id='1'"));
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 col-12">
                      <div class="form-group">
                          ...
                          <select id='pickup_location' class="full-width js-roomCount" required>
                              <?php echo $pick_html; ?>
                    ...
                    <div class="col-md-4 col-sm-6 col-12">
                      <div class="form-group">
                          ...
                          <div class="datepicker-wrap">
                              <input type="text" name="pickup_date" class="input-text full-width" placeholder="mm/dd/yy H:i" id="pickup_date" value="<?= $pick_drop_array[0]->pickup_date ?>" required/>
                          </div>
                      </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-12">
                      <div class="form-group">
                        ...
                        <input type="number" name="passengers" class="input-text full-width" placeholder="Total Passengers" id="passengers" value="<?= $pick_drop_array[0]->passengers ?>" required/>
                      </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-12">
                      <div class="form-group">
                        <label>Drop-Off Location</label>
                          <div class="c-select2DD">
                          <select id='dropoff_location' class="full-width js-roomCount" required>
                              <?php echo $drop_html; ?>
    ...
    <div class="row">
      ...
      if(($pickup_time >= $pick1[0]) && ($pickup_time <= $pick2[0])){
        ...
        while(($row_query  = mysql_fetch_assoc($sq_query))){
          ...
          //Tariff Master
          $sq_tariff_master = mysql_query("select * from b2b_transfer_tariff where vehicle_id='$row_query[entry_id]'");
          while($row_tariff_master = mysql_fetch_assoc($sq_tariff_master)){
            ...
            for($i_date=0; $i_date<sizeof($checkDate_array); $i_date++){
                if($i_date === 0){
                  $sq_tariff = mysql_query("select * from b2b_transfer_tariff_entries where tariff_id='$row_tariff_master[tariff_id]' and pickup_location = '$pickup_id' and drop_location = '$drop_id' and (from_date <='$checkDate_array[$i_date]' and to_date>='$checkDate_array[$i_date]')");
                }else{
                  $sq_tariff = mysql_query("select * from b2b_transfer_tariff_entries where tariff_id='$row_tariff_master[tariff_id]' and pickup_location = '$drop_id' and drop_location = '$pickup_id' and (from_date <='$checkDate_array[$i_date]' and to_date>='$checkDate_array[$i_date]')");
                }
        ...
        if($pick_drop_array[0]->trip_type == 'roundtrip') {
          ...
          for($i=0;$i<sizeof($transfer_result_array);$i++){
            ...
            for($j=$i+1;$j<=$i+1;$j++){
              ...
              if($transfer_result_array[$i]['vehicle_id'] == $transfer_result_array[$j]['vehicle_id'] && $transfer_result_array[$i]['trip_date'] != $transfer_result_array[$j]['trip_date']){
