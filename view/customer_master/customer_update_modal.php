      ...
      <div class="modal-body">
        ...
        <div class="panel panel-default panel-body app_panel_style mg_tp_30 feildset-panel">
          ...
          <div class="row">             
              ...
              <div class="col-sm-4 col-xs-12">
                  <input type="text" id="cust_anni_date" name="cust_anni_date" placeholder="Anniversary Date" title="Anniversary Date" value="<?php echo get_date_user($sq_customer['anni_date']);?>" >

                </div>
                <div class="col-sm-4 col-xs-12">
                  <input type="text" id="payment_date" name="payment_date" placeholder="Payment Due Date" title="Payment Due Date" value="<?php echo get_date_user($sq_customer['payment_date']);?>" >
            ...
            <div class="row">
              ...
              <div class="col-sm-4 col-xs-12 hidden">
                <select name="cust_mail_opt" id="cust_mail_opt" title="Customer Mail Option">
                  <option value="<?= $sq_customer['mail_opt'] ?>"><?= $sq_customer['mail_opt'] ?></option>
