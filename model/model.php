...
$db_connect=mysql_select_db("itourscl_global");
if(!$db_connect) { echo "Database Not Connected."; }

define('BASE_URL', 'http://localhost:7777/global_travel/');
...
$authKey = "a1df4fce1c7a8d344b597b4e545a1e67";
    //Multiple mobiles numbers separated by comma
    $mobileNumber = urlencode($mobile_no); ;
    ...
    //API URL
//generated api - 
   // $url="http://sms.bulksmsserviceproviders.com/api/balance.php?authkey=a1df4fce1c7a8d344b597b4e545a1e67&route=default";
    //$url = "http://sms.bulksmsserviceproviders.com/api/send_http.php";
    $url="http://sms.bulksmsserviceproviders.com/api/send_http.php?authkey=a1df4fce1c7a8d344b597b4e545a1e67&mobiles=$mobileNumber&message=$message&sender=$senderId&route=$route";
    //echo $url;
    // init the resource
    $ch = curl_init();
