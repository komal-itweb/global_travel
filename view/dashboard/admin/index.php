		       ...
		       <div class="row">
		       	<div class="col-md-12">
			          ...
			          <ul class="nav nav-tabs responsive" role="tablist">
						...
						<li role="presentation"><a href="#upcoming_birthday" aria-controls="upcoming_birthday" role="tab" data-toggle="tab">Upcoming Birthdays</a></li>
						<li role="presentation"><a href="#upcoming_anniversary" aria-controls="upcoming_anniversary" role="tab" data-toggle="tab">Upcoming Anniversary</a></li>
					  </ul>
				                  ...
				                  <div class="col-md-12 no-pad table_verflow"> 
				                    <div class="table-responsive">
				                      <table class="table table-hover" style="margin: 0 !important;border: 0;">
										...
										<!-- //package Booking -->
										<?php
										$query = "SELECT * FROM customer_master WHERE DATE_ADD(birth_date, INTERVAL YEAR(CURDATE())-YEAR(birth_date) + IF(DAYOFYEAR(CURDATE()) > DAYOFYEAR(birth_date),1,0) YEAR) BETWEEN CURDATE() AND DATE_ADD(CURDATE(), INTERVAL 7 DAY)";
										$count = 1;
				          				...
				          				while($row_query=mysql_fetch_assoc($sq_query)){
											  ?>
												<tr class="<?= $bg ?>">
												<td><?php echo $count++; ?></td>
												<td><?php echo $row_query['first_name'].' '.$row_query['last_name']; ?></td>
				                  ...
				                  <div class="col-md-12 no-pad table_verflow"> 
				                    <div class="table-responsive">
				                      <table class="table table-hover" style="margin: 0 !important;border: 0;">
										...
										<!-- //package Booking -->
										<?php
										$query = "SELECT * FROM customer_master WHERE DATE_ADD(anni_date, INTERVAL YEAR(CURDATE())-YEAR(anni_date) + IF(DAYOFYEAR(CURDATE()) > DAYOFYEAR(anni_date),1,0) YEAR) BETWEEN CURDATE() AND DATE_ADD(CURDATE(), INTERVAL 7 DAY)";
										$count = 1;
