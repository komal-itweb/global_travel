...
<script>
	...
	function list_reflect()
	{
		...
		$.post(base_url+'view/visa_passport_ticket/ticket/payment_status/list_reflect.php', { customer_id : customer_id, ticket_id_filter : ticket_id_filter,from_date : from_date, to_date : to_date, cust_type : cust_type, company_name : company_name,booker_id:booker_id,branch_id : branch_id, branch_status : branch_status }, function(data){
	...
	function excel_report()
	{
		...
		window.location = base_url+'view/visa_passport_ticket/ticket/payment_status/excel_report.php?customer_id='+customer_id+'&ticket_id='+ticket_id+'&from_date='+from_date+'&to_date='+to_date+'&cust_type='+cust_type+'&company_name='+company_name+'&booker_id='+booker_id+'&branch_id='+branch_id+'&branch_status='+branch_status;
	}
