...
// Paid
$query = mysql_fetch_assoc(mysql_query("SELECT sum(payment_amount) as sum from exc_payment_master where exc_id='$exc_id' and clearance_status != 'Pending' and clearance_status != 'Cancelled'"));
				 ...
				 while($row_exc_payment = mysql_fetch_assoc($sq_exc_payment)){
				 	if($row_exc_payment['payment_amount'] != '0'){
						...
						<tr class="<?php echo $bg; ?>">
					        ...
					        <td class="text-right"><?php echo $row_exc_payment['payment_amount']; ?></td>
					    </tr>
				    <?php   } 
				    } ?>
				</tbody>
