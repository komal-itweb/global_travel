...
$objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('N'.$row_count, "Net Amount")
        ->setCellValue('O'.$row_count, "Taxable Amount")
        ->setCellValue('P'.$row_count, "IGST_%")
        ->setCellValue('Q'.$row_count, "IGST Amount")
        ->setCellValue('R'.$row_count, "CGST_%")
        ->setCellValue('S'.$row_count, "CGST Amount")
        ->setCellValue('T'.$row_count, "SGST_%")
        ->setCellValue('U'.$row_count, "SGST Amount")
        ->setCellValue('V'.$row_count, "UTGST_s%")
        ->setCellValue('W'.$row_count, "UTGST Amount")
        ->setCellValue('X'.$row_count, "Cess%")
        ->setCellValue('Y'.$row_count, "Cess Amount")
        ->setCellValue('Z'.$row_count, "ITC Eligibility")
        ->setCellValue('AA'.$row_count, "Reverse Charge");
...
while($row_query = mysql_fetch_assoc($sq_query))
  {
    ...
    if($sq_count['booking_count'] != $sq_cancel_count['cancel_count'])
    {
        ...
        $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('N'.$row_count, $row_query['passport_total_cost'])
            ->setCellValue('O'.$row_count, number_format($taxable_amount,2))
            ->setCellValue('P'.$row_count, ($sq_tax_name['tax_type'] == 'IGST') ? $tax_per : '0')
            ->setCellValue('Q'.$row_count, ($sq_tax_name['tax_type'] == 'IGST') ? $tax_amount : '0')
            ->setCellValue('R'.$row_count, ($sq_tax_name['tax_type'] == 'SGST+CGST') ? ($tax_per/2) : '0')
            ->setCellValue('S'.$row_count, ($sq_tax_name['tax_type'] == 'SGST+CGST') ? ($tax_amount/2) : '0')
            ->setCellValue('T'.$row_count, ($sq_tax_name['tax_type'] == 'SGST+CGST') ? ($tax_per/2) : '0')
            ->setCellValue('U'.$row_count, ($sq_tax_name['tax_type'] == 'SGST+CGST') ? ($tax_amount/2) : '0')
            ->setCellValue('V'.$row_count, ($sq_tax_name['tax_type'] == 'UGST') ? $tax_per : '0')
            ->setCellValue('W'.$row_count, ($sq_tax_name['tax_type'] == 'UGST') ? $tax_amount : '0') 
            ->setCellValue('X'.$row_count,'0.00')
            ->setCellValue('Y'.$row_count,'0.00')
...
while($row_query = mysql_fetch_assoc($sq_query))
{
  ...
  if($sq_count['booking_count'] != $sq_cancel_count['cancel_count'])
  {
    ...
    $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('L'.$row_count, $row_query['taxation_type'])
            ->setCellValue('M'.$row_count, $row_query['service_tax'])
            ->setCellValue('N'.$row_count, $row_query['visa_total_cost'])
            ->setCellValue('O'.$row_count, number_format($taxable_amount,2))
            ->setCellValue('P'.$row_count, ($sq_tax_name['tax_type'] == 'IGST') ? $tax_per : '0')
            ->setCellValue('Q'.$row_count, ($sq_tax_name['tax_type'] == 'IGST') ? $tax_amount : '0')
            ->setCellValue('R'.$row_count, ($sq_tax_name['tax_type'] == 'SGST+CGST') ? ($tax_per/2) : '0')
...
//Bus Booking
    ...
    $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('L'.$row_count, $row_query['taxation_type'])
            ->setCellValue('M'.$row_count, $row_query['service_tax'])
            ->setCellValue('N'.$row_count, $row_query['net_total'])
            ->setCellValue('O'.$row_count, number_format($taxable_amount,2))
            ->setCellValue('P'.$row_count, ($sq_tax_name['tax_type'] == 'IGST') ? $tax_per : '0')
            ->setCellValue('Q'.$row_count, ($sq_tax_name['tax_type'] == 'IGST') ? $tax_amount : '0')
            ->setCellValue('R'.$row_count, ($sq_tax_name['tax_type'] == 'SGST+CGST') ? ($tax_per/2) : '0')
  ...
  if($sq_count['booking_count'] != $sq_cancel_count['cancel_count'])
  {
    ...
    if($sq_tax_name['tax_type'] == 'IGST'){ $igst_total += $tax_amount; }
        ...
        $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('L'.$row_count, $row_query['taxation_type'])
            ->setCellValue('M'.$row_count, $row_query['service_tax'])
            ->setCellValue('N'.$row_count, $row_query['exc_total_cost'])
            ->setCellValue('O'.$row_count, number_format($taxable_amount,2))
            ->setCellValue('P'.$row_count, ($sq_tax_name['tax_type'] == 'IGST') ? $tax_per : '0')
            ->setCellValue('Q'.$row_count, ($sq_tax_name['tax_type'] == 'IGST') ? $tax_amount : '0')
            ->setCellValue('R'.$row_count, ($sq_tax_name['tax_type'] == 'SGST+CGST') ? ($tax_per/2) : '0')
  ...
  if($sq_count['booking_count'] != $sq_cancel_count['cancel_count'])
  {
    ...
    if($sq_tax_name['tax_type'] == 'IGST'){ $igst_total += $tax_amount; }
        ...
        $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('L'.$row_count, $row_query['taxation_type'])
            ->setCellValue('M'.$row_count, $row_query['service_tax'])
            ->setCellValue('N'.$row_count, $row_query['total_fee'])
            ->setCellValue('O'.$row_count, number_format($taxable_amount,2))
            ->setCellValue('P'.$row_count, ($sq_tax_name['tax_type'] == 'IGST') ? $tax_per : '0')
            ->setCellValue('Q'.$row_count, ($sq_tax_name['tax_type'] == 'IGST') ? $tax_amount : '0')
            ->setCellValue('R'.$row_count, ($sq_tax_name['tax_type'] == 'SGST+CGST') ? ($tax_per/2) : '0')
...
while($row_query = mysql_fetch_assoc($sq_query))
{
  ...
  if($sq_tax_name['tax_type'] == 'IGST'){ $igst_total += $tax_amount; }
        ...
        $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('L'.$row_count, $row_query['taxation_type'])
            ->setCellValue('M'.$row_count, $row_query['service_tax'])
            ->setCellValue('N'.$row_count, $row_query['total_fees'])
            ->setCellValue('O'.$row_count, number_format($taxable_amount,2))
            ->setCellValue('P'.$row_count, ($sq_tax_name['tax_type'] == 'IGST') ? $tax_per : '0')
            ->setCellValue('Q'.$row_count, ($sq_tax_name['tax_type'] == 'IGST') ? $tax_amount : '0')
            ->setCellValue('R'.$row_count, ($sq_tax_name['tax_type'] == 'SGST+CGST') ? ($tax_per/2) : '0')
  ...
  if($sq_count['booking_count'] != $sq_cancel_count['cancel_count'])
  {
    ...
    if($sq_tax_name['tax_type'] == 'IGST'){ $igst_total += $tax_amount; }
        ...
        $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('L'.$row_count, $row_query['taxation_type'])
            ->setCellValue('M'.$row_count, $row_query['service_tax'])
            ->setCellValue('N'.$row_count, $row_query['ticket_total_cost'])
            ->setCellValue('O'.$row_count, number_format($taxable_amount,2))
            ->setCellValue('P'.$row_count, ($sq_tax_name['tax_type'] == 'IGST') ? $tax_per : '0')
            ->setCellValue('Q'.$row_count, ($sq_tax_name['tax_type'] == 'IGST') ? $tax_amount : '0')
            ->setCellValue('R'.$row_count, ($sq_tax_name['tax_type'] == 'SGST+CGST') ? ($tax_per/2) : '0')
  ...
  if($sq_count['booking_count'] != $sq_cancel_count['cancel_count'] || $sq_group['status'] != 'Cancel')
  {
     ...
     //Train
        ...
        $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('K'.$row_count, ($sq_state['state_name'] == '') ? 'NA' : $sq_state['state_name'])
            ->setCellValue('L'.$row_count, $row_query['taxation_type'])
            ->setCellValue('M'.$row_count, $row_query['train_service_tax'])
            ->setCellValue('N'.$row_count, $row_query['total_train_expense'])
            ->setCellValue('O'.$row_count, number_format($taxable_amount,2))
            ->setCellValue('P'.$row_count, ($sq_tax_name['tax_type'] == 'IGST') ? $tax_per : '0')
            ->setCellValue('Q'.$row_count, ($sq_tax_name['tax_type'] == 'IGST') ? $tax_amount : '0')
            ->setCellValue('R'.$row_count, ($sq_tax_name['tax_type'] == 'SGST+CGST') ? ($tax_per/2) : '0')
      ...
      if($taxation_id != '0'){
        if($row_query['plane_taxation_id'] == $taxation_id){
          if($sq_tax_name['tax_type'] == 'IGST'){ $igst_total += $tax_amount; }
                ...
                ->setCellValue('K'.$row_count, ($sq_state['state_name'] == '') ? 'NA' : $sq_state['state_name'])
                ->setCellValue('L'.$row_count, $row_query['taxation_type'])
                ->setCellValue('M'.$row_count, $row_query['plane_service_tax'])
                ->setCellValue('N'.$row_count, $row_query['total_plane_expense'])
                ->setCellValue('O'.$row_count, number_format($taxable_amount,2))
                ->setCellValue('P'.$row_count, ($sq_tax_name['tax_type'] == 'IGST') ? $tax_per : '0')
                ->setCellValue('Q'.$row_count, ($sq_tax_name['tax_type'] == 'IGST') ? $tax_amount : '0')
                ->setCellValue('R'.$row_count, ($sq_tax_name['tax_type'] == 'SGST+CGST') ? ($tax_per/2) : '0')
      ...
      if($taxation_id != '0'){
        if($row_query['plane_taxation_id'] == $taxation_id){
          if($sq_tax_name['tax_type'] == 'IGST'){ $igst_total += $tax_amount; }
              ...
              ->setCellValue('K'.$row_count, ($sq_state['state_name'] == '') ? 'NA' : $sq_state['state_name'])
              ->setCellValue('L'.$row_count, $row_query['taxation_type'])
              ->setCellValue('M'.$row_count, $row_query['cruise_service_tax'])
              ->setCellValue('N'.$row_count, $row_query['total_cruise_expense'])
              ->setCellValue('O'.$row_count, number_format($taxable_amount,2))
              ->setCellValue('P'.$row_count, ($sq_tax_name['tax_type'] == 'IGST') ? $tax_per : '0')
              ->setCellValue('Q'.$row_count, ($sq_tax_name['tax_type'] == 'IGST') ? $tax_amount : '0')
              ->setCellValue('R'.$row_count, ($sq_tax_name['tax_type'] == 'SGST+CGST') ? ($tax_per/2) : '0')
        ...
        if($row_query['visa_taxation_id'] == $taxation_id){
          if($sq_tax_name['tax_type'] == 'IGST'){ $igst_total += $tax_amount; }
            ...
            $objPHPExcel->setActiveSheetIndex(0)
              ...
              ->setCellValue('K'.$row_count, ($sq_state['state_name'] == '') ? 'NA' : $sq_state['state_name'])
              ->setCellValue('L'.$row_count, $row_query['taxation_type'])
              ->setCellValue('M'.$row_count, $row_query['visa_service_tax'])
              ->setCellValue('N'.$row_count, $row_query['visa_total_amount'])
              ->setCellValue('O'.$row_count, number_format($taxable_amount,2))
              ->setCellValue('P'.$row_count, ($sq_tax_name['tax_type'] == 'IGST') ? $tax_per : '0')
              ->setCellValue('Q'.$row_count, ($sq_tax_name['tax_type'] == 'IGST') ? $tax_amount : '0')
              ->setCellValue('R'.$row_count, ($sq_tax_name['tax_type'] == 'SGST+CGST') ? ($tax_per/2) : '0')
        ...
        if($row_query['insuarance_taxation_id'] == $taxation_id){
          if($sq_tax_name['tax_type'] == 'IGST'){ $igst_total += $tax_amount; }
            ...
            $objPHPExcel->setActiveSheetIndex(0)
              ...
              ->setCellValue('K'.$row_count, ($sq_state['state_name'] == '') ? 'NA' : $sq_state['state_name'])
              ->setCellValue('L'.$row_count, $row_query['taxation_type'])
              ->setCellValue('M'.$row_count, $row_query['insuarance_service_tax'])
              ->setCellValue('N'.$row_count, $row_query['insuarance_total_amount'])
              ->setCellValue('O'.$row_count, number_format($taxable_amount,2))
              ->setCellValue('P'.$row_count, ($sq_tax_name['tax_type'] == 'IGST') ? $tax_per : '0')
              ->setCellValue('Q'.$row_count, ($sq_tax_name['tax_type'] == 'IGST') ? $tax_amount : '0')
              ->setCellValue('R'.$row_count, ($sq_tax_name['tax_type'] == 'SGST+CGST') ? ($tax_per/2) : '0')
      ...
      if($taxation_id != '0'){
        if($row_query['tour_taxation_id'] == $taxation_id){
          if($sq_tax_name['tax_type'] == 'IGST'){ $igst_total += $tax_amount; }
            ...
            ->setCellValue('K'.$row_count, ($sq_state['state_name'] == '') ? 'NA' : $sq_state['state_name'])
            ->setCellValue('L'.$row_count, $row_query['taxation_type'])
            ->setCellValue('M'.$row_count, $row_query['service_tax_per'])
            ->setCellValue('N'.$row_count, $row_query['total_tour_fee'])
            ->setCellValue('O'.$row_count, number_format($taxable_amount,2))
            ->setCellValue('P'.$row_count, ($sq_tax_name['tax_type'] == 'IGST') ? $tax_per : '0')
            ->setCellValue('Q'.$row_count, ($sq_tax_name['tax_type'] == 'IGST') ? $tax_amount : '0')
            ->setCellValue('R'.$row_count, ($sq_tax_name['tax_type'] == 'SGST+CGST') ? ($tax_per/2) : '0')
       ...
       if($row_query['tour_taxation_id'] == $taxation_id){
         if($sq_tax_name['tax_type'] == 'IGST'){ $igst_total += $tax_amount; }
            ...
            $objPHPExcel->setActiveSheetIndex(0)
              ...
              ->setCellValue('K'.$row_count, ($sq_state['state_name'] == '') ? 'NA' : $sq_state['state_name'])
              ->setCellValue('L'.$row_count, $row_query['taxation_type'])
              ->setCellValue('M'.$row_count, $row_query['tour_service_tax'])
              ->setCellValue('N'.$row_count, $row_query['actual_tour_expense'])
              ->setCellValue('O'.$row_count, number_format($taxable_amount,2))
              ->setCellValue('P'.$row_count, ($sq_tax_name['tax_type'] == 'IGST') ? $tax_per : '0')
              ->setCellValue('Q'.$row_count, ($sq_tax_name['tax_type'] == 'IGST') ? $tax_amount : '0')
              ->setCellValue('R'.$row_count, ($sq_tax_name['tax_type'] == 'SGST+CGST') ? ($tax_per/2) : '0')
...
$query = "select * from other_income_master where 1 ";
        ...
        $sq_query = mysql_query($query);
          while($row_query = mysql_fetch_assoc($sq_query))
          {
            ...
            $sq_customer = mysql_fetch_assoc(mysql_query("select * from customer_master where customer_id='$row_query[receipt_from]'"));
              $hsn_code = '9985';
        ...
        $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('D'.$row_count, $hsn_code)
            ->setCellValue('E'.$row_count, $sq_customer['first_name'].' '.$sq_customer['last_name'])
            ->setCellValue('F'.$row_count, ($sq_customer['service_tax_no'] == '') ? 'NA' : $sq_customer['service_tax_no'])
            ->setCellValue('G'.$row_count, ($sq_supply['state_name'] == '') ? 'NA' : $sq_supply['state_name'])
...
$objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('N'.$row_count,'Total' )
        ->setCellValue('O'.$row_count,'' )
        ->setCellValue('P'.$row_count,'' )
        ->setCellValue('Q'.$row_count,number_format($igst_total,2) )
        ->setCellValue('R'.$row_count,'' )
        ->setCellValue('S'.$row_count,number_format($scgst_total/2,2))
        ->setCellValue('T'.$row_count,'' )
        ->setCellValue('U'.$row_count,number_format($scgst_total/2,2))
        ->setCellValue('V'.$row_count, '')
        ->setCellValue('W'.$row_count,number_format($ugst_total,2))
...
header('Content-Disposition: attachment;filename="GST On Sale Report('.date('d-m-Y H:i:s').').xls"');
