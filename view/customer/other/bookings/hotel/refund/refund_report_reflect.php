...
<table class="table table-bordered table-hover" id="tbl_refund" style="margin: 20px 0 !important">
	...
	<tbody>
		...
		while($row_refund = mysql_fetch_assoc($sq_refund)){
			...
			if($row_refund['clearance_status']=="Cancelled"){ $bg='success';
	...
	<tfoot>
		<tr class="active">
			...
			<th colspan="2" class="text-right success">Total : <?= number_format(($total_refund_amt - $sq_pending_amount - $sq_can_amount),2);?></th>
		</tr>
	</tfoot>
</table>
