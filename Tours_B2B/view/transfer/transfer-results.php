...
$transfer_results_array = $_POST['final_arr'];
?>
<input type='hidden' value='<?= json_encode($transfer_results_array,JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP | JSON_UNESCAPED_UNICODE) ?>' id='transfer_results' name='transfer_results'/>
