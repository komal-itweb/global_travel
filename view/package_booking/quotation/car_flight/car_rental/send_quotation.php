...
$query = "select * from car_rental_quotation_master where email_id = '$email_id' ";
	  ...
	  <div class="col-xs-12">
		  ...
		  <table class="table table-hover table-bordered no-marg" id="tbl_tour_list">
		    ...
		    while($row_tours = mysql_fetch_assoc($sq_query)){
			    ...
			    $quotation_cost =  $row_tours['total_tour_cost'];
...
function multiple_quotation_mail()
{
	...
	$.ajax({
			type:'post',
			url: base_url+'controller/package_tour/quotation/car_rental/quotation_email_send.php',
