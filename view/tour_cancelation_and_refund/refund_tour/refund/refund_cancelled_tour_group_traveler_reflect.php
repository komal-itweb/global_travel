...
$sql = mysql_query("SELECT SUM(amount) as total FROM payment_master where tourwise_traveler_id ='$tourwise_id' and payment_for = 'Travelling' and clearance_status!='Pending' AND clearance_status!='Cancelled'");
$row = mysql_fetch_array($sql);
$traveling_amount_paid = $row['total'];

$sql1 = mysql_query("SELECT SUM(amount) as total FROM payment_master where tourwise_traveler_id ='$tourwise_id' and payment_for = 'Tour' and clearance_status!='Pending' AND clearance_status!='Cancelled' ");
...
if($sq_est_count!='0')
{
    ...
    $booking_fee=$tourwise_details1['total_travel_expense'] + $tourwise_details1['total_tour_fee'];
