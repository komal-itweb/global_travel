...
$sq = mysql_fetch_assoc(mysql_query("select * from branch_assign where link='inter_banks/index.php'"));
...
function list_reflect()
{
	...
	var branch_status = $('#branch_status').val();
	$.post('inter_banks/list_reflect.php',{ from_date : from_date, to_date : to_date, bank_id : bank_id, financial_year_id : financial_year_id , branch_status : branch_status}, function(data){
		$('#div_list').html(data);
	});
}
list_reflect();
...
function excel_report()
  {
	...
	var financial_year_id = $('#financial_year_id_filter').val();
    var branch_status = $('#branch_status').val();
    window.location = 'inter_banks/excel_report.php?bank_id='+bank_id+'&from_date='+from_date+'&to_date='+to_date+'&financial_year_id='+financial_year_id+'&branch_status='+branch_status;
  }
