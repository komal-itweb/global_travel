...
<table class="table table-hover" id="tbl_payment_expense1" style="margin: 20px 0 !important;">
	...
	<tfoot>
		<tr class="active">
			...
			<th colspan="1" class="text-right danger">Total Cancelled : <?= number_format($sq_canc['cancel'], 2); ?></th>
			<th colspan="1" class="text-right success">Total Paid : <?= number_format($total_paid_amt, 2); ?></th>
