                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown_menu no-pad">
	                        ...
	                        <li class="dropdown_two">
	                          <span onclick="show_sub_menu('sub_menu_1')">GST Reports</span>
	                          <ul class="dropdown_menu_two" id="sub_menu_1">
	                            <li><span onclick="show_report_reflect('ITC Report')">ITC Report</span></li>
	                            <li><span onclick="show_report_reflect('GST on Sales')">GST on Sales</span></li>
	                            <li class="dropdown_three">
	                            	<span onclick="show_third_level_menu('third_level_menu_1')">GST on Cancellation</span>
	                            	<ul class="dropdown_menu_three" id="third_level_menu_1">
			                           <li><span onclick="show_report_reflect('GST on Sale Cancel')">GST on Sale Cancel</span></li>
			                           <li><span onclick="show_report_reflect('GST on Purchase Cancel')">GST on Purchase Cancel</span></li>
			                        </ul>
	                            </li>
	                          </ul>
	                        </li>
...
function show_report_reflect(report_name){
	...
	if(report_name=="ITC Report"){ url = 'taxation_reports/itc_report/index.php?branch_status=<?= $branch_status ?>'; }
  	if(report_name=="GST on Sales"){ url = 'taxation_reports/gst_sale/index.php?branch_status=<?= $branch_status ?>'; }
  	
  	if(report_name=="GST on Sale Cancel"){ url = 'taxation_reports/gst_cancel/sale/index.php?branch_status=<?= $branch_status ?>'; }
  	if(report_name=="GST on Purchase Cancel"){ url = 'taxation_reports/gst_cancel/purchase/index.php?branch_status=<?= $branch_status ?>'; }
