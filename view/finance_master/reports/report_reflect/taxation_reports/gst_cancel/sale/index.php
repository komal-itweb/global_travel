...
function report_reflect()
{
	...
	$.post('report_reflect/taxation_reports/gst_cancel/sale/report_reflect.php',{ from_date : from_date, to_date : to_date , branch_status : branch_status,taxation_id : taxation_id , role : role,branch_admin_id : branch_admin_id    }, function(data){
 ...
 function excel_report()
{
	...
	var role = $('#role').val();
	var taxation_id = $('#taxation_id').val();
	window.location = 'report_reflect/taxation_reports/gst_cancel/sale/excel_report.php?from_date='+from_date+'&to_date='+to_date+'&taxation_id='+taxation_id+'&branch_status='+branch_status+'&branch_admin_id='+branch_admin_id+'&role='+role;
}
</script>
