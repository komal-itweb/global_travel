...
var column = [
	...
	{ title : "Total_sale", className:"info text-right"},
...
{  
	...
	var base_url = $('#base_url').val();
	var branch_status = $('#branch_status').val();
  	$.post(base_url+'view/bus_booking/booking/booking/company_name_load.php', { cust_type : cust_type, branch_status : branch_status }, function(data){
...
//*******************Get Dynamic Customer Name Dropdown**********************//
	...
	function dynamic_customer_load(cust_type, company_name)
	{
	  ...
	  var base_url = $('#base_url').val();
	  var branch_status = $('#branch_status').val();
	    $.get(base_url+"view/bus_booking/booking/booking/get_customer_dropdown.php", { cust_type : cust_type , company_name : company_name, branch_status : branch_status}, function(data){
