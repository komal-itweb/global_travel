         ...
         <legend>Quotation Details</legend>
          <div class="row">
            <div class="col-md-4 col-sm-6 col-xs-12 ">
              <select name="quotation_id" id="quotation_id" style="width:100%" onchange="get_enquiry_details('')" class="form-control">
          ...
          <div class="row">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
              <input type="text" id="total_mini_km" name="total_mini_km" placeholder="Total Mini Km" title="Total Mini Km"  class="text-right form-control">
            </div>
            <div class="col-md-4 col-sm-6 col-xs-12 mg_bt_10">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <legend>Costing Details</legend>
              ...
              <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
                  <input type="text" id="night_halt" name="night_halt" class="text-right form-control" placeholder="Night Halt" title="Night Halt" onchange="calculate_total_fees(this.id);validate_balance(this.id)">
                </div>
              </div>
              <div class="row">
                <div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
...
$('#from_date,#to_date,#total_hrs,#total_km,#total_max_km,#total_mini_km,#driver_allowance,#permit_charges,#toll_and_parking,#state_entry_tax,#other_charges,#night_halt,#local_places_to_visit,#places_to_visit,#traveling_date').hide();
function reflect_feilds(){
	var type = $('#travel_type').val();
	
	if(type=='Local'){
		$('#from_date,#to_date,#total_hrs,#total_km,#local_places_to_visit').show();
		$('#total_max_km,#total_mini_km,#driver_allowance,#permit_charges,#toll_and_parking,#state_entry_tax,#other_charges,#places_to_visit,#traveling_date').hide();
	}
	if(type=='Outstation'){
		$('#from_date,#to_date,#total_hrs,#total_km,#local_places_to_visit').hide();
		$('#total_max_km,#total_mini_km,#driver_allowance,#permit_charges,#toll_and_parking,#state_entry_tax,#other_charges,#night_halt,#places_to_visit,#traveling_date').show();
	}
}
