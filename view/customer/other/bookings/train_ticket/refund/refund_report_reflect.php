...
<table class="table table-bordered table-hover cust_table" id="tbl_refund" style="margin:20px 0 !important;">
	...
	<tfoot>
		<tr class="active">
			<th colspan="1" class="text-right success" >Refund : <?= ($sq_paid_amount=='')?number_format(0,2):number_format($sq_paid_amount,2); ?></th>
			...
			<th colspan="2" class="text-right success">Total : <?= number_format(($sq_paid_amount - $sq_pending_amount - $sq_can_amount),2);?></th>
		</tr>
	</tfoot>
</table>
