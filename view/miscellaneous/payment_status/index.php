...
function list_reflect()
{
	...
	$.post(base_url+'view/miscellaneous/payment_status/list_reflect.php', { customer_id : customer_id, misc_id : misc_id, from_date : from_date, to_date : to_date, cust_type : cust_type, company_name : company_name,booker_id:booker_id,branch_id : branch_id, branch_status : branch_status }, function(data){
...
list_reflect();
	...
	function excel_report()
	{
		...
		var base_url = $('#base_url').val();
		var branch_status = $('#branch_status').val();
		window.location = base_url+'view/miscellaneous/payment_status/excel_report.php?customer_id='+customer_id+'&misc_id='+misc_id+'&from_date='+from_date+'&to_date='+to_date+'&cust_type='+cust_type+'&company_name='+company_name+'&booker_id='+booker_id+'&branch_id='+branch_id+'&branch_status='+branch_status;
	}
	...
	function dynamic_customer_load(cust_type, company_name)
	{
      ...
      var base_url = $('#base_url').val();
	    $.get(base_url+"view/miscellaneous/home/get_customer_dropdown.php", { cust_type : cust_type , company_name : company_name, branch_status : branch_status}, function(data){
	...
	{  
	    ...
	    var base_url = $('#base_url').val();
	    var branch_status = $('#branch_status').val();
	  	$.post(base_url+'view/miscellaneous/home/company_name_load.php', { cust_type : cust_type, branch_status : branch_status }, function(data){
...
function visa_id_dropdown_load(customer_id_filter, visa_id_filter)
{
	...
	var base_url = $('#base_url').val();
	var branch_status = $('#branch_status').val();
	$.post(base_url+'view/miscellaneous/visa_id_dropdown_load.php', { customer_id : customer_id , branch_status : branch_status}, function(data){
