  ...
  <div class="clearfix">
    <div class="row">
        <div class="col-md-8">
            ...
            <input type="text" id="from_date_filter" onchange="list_reflect();" class="txtBox d-inline-block wAuto" placeholder="From Date" />
            <input type="text" id="to_date_filter" onchange="list_reflect();" class="txtBox d-inline-block wAuto" placeholder="To Date" />
            </div>
        </div>
    </div>
  </div>
