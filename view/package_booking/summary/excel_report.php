...
$row_count = 11;
       ...
       $objPHPExcel->setActiveSheetIndex(0)
        ...
        while($row_package = mysql_fetch_assoc($sq_package)){
            ...
            $balance_total = $balance_total + $total_balance - $credit_card_charges;
            /////// Purchase ////////
            $total_purchase = 0;
            $purchase_amt = 0;
            $i=0;
    	...
    	$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('L'.$row_count, number_format($row_package['service_charge'],2))
            ...
            ->setCellValue('P'.$row_count, number_format($tour_esti,2))
            ->setCellValue('Q'.$row_count, number_format($total_amount,2))
            ->setCellValue('R'.$row_count, number_format($paid_amount+$credit_card_charges,2))
            ->setCellValue('S'.$row_count, number_format($total_balance,2))
            ->setCellValue('T'.$row_count, get_date_user($row_package['due_date']))
