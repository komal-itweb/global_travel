      ...
      <div class="modal-body">
        ...
        <div class="panel panel-default panel-body app_panel_style mg_tp_30 feildset-panel">
            ...
            <div class="row">
              ...
              <div class="col-sm-4 col-xs-12">
                  <input type="text" id="cust_anni_date" name="cust_anni_date" placeholder="Anniversary Date" title="Anniversary Date" onchange="calculate_age_generic('cust_birth_date', 'cust_age') ; " >

                </div>
                <div class="col-sm-4 col-xs-12 hidden">
                  <input type="text" id="payment_date" name="payment_date" placeholder="Payment Due Date" title="Payment Due Date" onchange="calculate_age_generic('cust_birth_date', 'cust_age') ; " >
          ...
          <div class="panel panel-default panel-body app_panel_style mg_tp_30 feildset-panel">
            ...
            <div class="row">
              ...
              <div class="col-sm-4 col-xs-12">
                <select name="cust_mail_opt" id="cust_mail_opt" title="Customer Mail Option">
                  <option value="Send">Send Mail</option>
                  <option value="NotSend">Don't Send Mail</option>
                </select>
              </div>
              <div class="col-sm-4 col-xs-12">
...
<script>
  ...
  $('#cust_anni_date').datetimepicker({ timepicker:false, format:'d-m-Y' });
...
$('#frm_customer_save').validate({
  ...
  submitHandler:function(form){
      ...
      var anni_date = $('#cust_anni_date').val();
      ...
      var cust_mail_opt = $('#cust_mail_opt').val();
