...
//Paid
$query = mysql_fetch_assoc(mysql_query("SELECT sum(payment_amount) as sum from car_rental_payment where booking_id='$booking_id' and clearance_status != 'Pending' and clearance_status != 'Cancelled'"));
				 ...
				 while($row_visa_payment = mysql_fetch_assoc($sq_visa_payment)){
				 	if($row_visa_payment['payment_amount'] != '0'){
						...
						<tr class="<?php echo $bg; ?>">
					        ...
					        <td class="text-right"><?php echo $row_visa_payment['payment_amount']; ?></td>
					    </tr>
				    <?php   } 
				    } ?>
				</tbody>
