	...
	submitHandler:function(form){
...

        {
...

          {
			...
			var main_ticket =($('#reissue_check1:checked').length > 0) ?  row.cells[10].childNodes[0].value : '';
