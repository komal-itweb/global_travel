	...
	<div class="col-md-6 col-md-offset-0 col-sm-8 col-sm-offset-2 col-xs-12 mg_bt_20_xs">
		<div class="widget_parent-bg-img bg-img-red">
			<?php     
	            ...
	            begin_widget();
	                $title_arr = array("Booking","Serv. Charge", " Tax", "Total Amount");
		            $content_arr = array( $sq_passport_info['passport_issue_amount'] ,$sq_passport_info['service_charge'], $service_tax_amount, $sq_passport_info['passport_total_cost']);
