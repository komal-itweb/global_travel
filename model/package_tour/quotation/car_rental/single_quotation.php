    ...
    <div class="container">
      ...
      <div class="navbar-header single_quotation_head">
        ...
        <div class="logo_right_part">
          <h1><i class="fa fa-pencil-square-o"></i> Car Rental Quotation</h1>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-xs-12">
          ...
          <ul class="pack_info">
            ...
            <li><span>Route Name </span>:  <?= $route; ?> </li>
        ...
        <div class="col-md-12">
          ...
          <div class="adolence_info mg_tp_25">
            ...
            <ul class="main_block">
              ...
              <li class="col-md-2 col-sm-4 col-xs-12 mg_bt_10_xs mg_bt_10"><span>Travel Type : </span><?= $sq_quotation['travel_type']; ?></li>
              <li class="col-md-2 col-sm-4 col-xs-12 mg_bt_10_xs mg_bt_10"><span>No of guests : </span><?= $sq_quotation['total_pax']; ?></li>
              <li class="col-md-2 col-sm-4 col-xs-12 mg_bt_10_xs mg_bt_10"><span>Total Days : </span><?= $sq_quotation['days_of_traveling']; ?></li>
              <li class="col-md-6 col-sm-4 col-xs-12 mg_bt_10_xs mg_bt_10"><span>Travel Date : </span><?= $travel_date; ?></li>
              
              <li class="col-md-2 col-sm-4 col-xs-12 mg_bt_10_xs"><span>Extra KM Cost : </span><?= $sq_quotation['extra_km_cost']; ?></li>
              <li class="col-md-2 col-sm-4 col-xs-12 mg_bt_10_xs"><span>Extra HR Cost : </span><?= $sq_quotation['extra_hr_cost']; ?></li>
              <li class="col-md-2 col-sm-4 col-xs-12 mg_bt_10_xs"><span>Total Hours : </span><?= $sq_quotation['total_hrs']; ?></li>
              <li class="col-md-2 col-sm-4 col-xs-12 mg_bt_10_xs"><span>Total KM : </span><?= $sq_quotation['total_km']; ?></li>
              <li class="col-md-2 col-sm-4 col-xs-12 mg_bt_10_xs"><span>Rate : </span><?= $sq_quotation['rate']; ?></li>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <?php
          if($sq_quotation['travel_type']=='Outstation'){
            ?>
            <li class="col-md-4 col-sm-6 col-xs-12 mg_bt_10"><span>Travel + Other Cost  : </span><?=number_format($sq_quotation['permit'] + $sq_quotation['toll_parking'] + $sq_quotation['driver_allowance'] + $sq_quotation['state_entry']+ $sq_quotation['other_charge'] + $sq_quotation['night_halt'] ,2); ?></li>
      <?php    }
          ?>
