          ...
          <div class="row">
            <div class="col-md-8 col-sm-12">
                ...
                <!-- ***** Hotel Listing ***** -->
                  <div class="c-cartContainer m20-btm">
                    ...
                    <div class="row align-items-center">
                      ...
                      <button id="quot_button" title="Check Availability" data-toggle="tooltip" class="c-button md colDark"  value="Payment" onclick="check_availability();">Check Availability</button>
                      </div>
                    </div>
                    ...
                    <div class="cartBody">
                      ...
                      <!-- **** Shopping Cart Item End****  -->
                  <?php
                  for($j=0;$j<sizeof($hotel_list_arr[$i]['service']['hotel_arr']['coupon_info_arr']);$j++){
                      array_push($coupon_list_arr,$hotel_list_arr[$i]['service']['hotel_arr']['coupon_info_arr'][$j]);
                  }
                } ?>
                    </div>
                  </div>
                  ...
                  <div class="c-cartContainer m20-btm">
                    ...
                    <div class="cartBody">
                      ...
                      for($i=0;$i<sizeof($activity_list_arr);$i++){
                        ...
                        $sq_exc = mysql_fetch_assoc(mysql_query("select timing_slots from excursion_master_tariff where entry_id='$exc_id'"));
                      ...
                      <!-- **** Shopping Cart Item End****  -->
                     <?php
                      for($j=0;$j<sizeof($activity_list_arr[$i]['service']['service_arr'][0]['coupon']);$j++){
                          array_push($coupon_list_arr,$activity_list_arr[$i]['service']['service_arr'][0]['coupon']['coupon_info_arr'][$j]);
                      }
                    } ?>
                    </div>
                  </div>
              ...
              <?php if(sizeof($tours_list_arr)>0){ ?>
                <!-- **** Transfer Listing **** -->
                <div class="c-cartContainer m20-btm">
                    <div class="cartHeading">Combo Tours Details</div>
                    <div class="cartBody">
                      <?php
                        ...
                        <div class="row">
                          ...
                          <div class="col-9 p0-left">
                            <div class="cartInfo">
                              <!-- **** Cart Header **** -->
                              <div class="cartHeader">
                                <span class="itemTitle"><?= $tours_list_arr[$i]['service']['service_arr'][0]['package'] ?></span>
            ...
            <div class="col-md-4 col-sm-12">
              <div class="c-cartContainer cartPricing">
                ...
                <!-- **** Pricing Block **** -->
                <div class="sBlock">
                  <span class="sBlock_title">Combo Tours</span>
                  <div class="row sBlock_price">
                    <div class="col-4">
                      <span class="pLabel">Price: </span>
                    </div>
                ...
                <!-- **** Pricing Block End **** -->
                <?php }
                  $grand_total += $hotel_total + $trans_total + $activity_total + $tours_total;
                ?>
                <!-- **** Pricing Block **** -->
