    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          ...
          <textarea class="form-control" id="other_comment" name="other_comment" placeholder="Other Comments" title="Other Comments"></textarea>
          </div>
        </div>
        </div>
