...
<script>
	...
	{  
		...
		var base_url = $('#base_url').val();
		var branch_status = $('#branch_status').val();
	  	$.post(base_url+'view/visa_passport_ticket/train_ticket/home/company_name_load.php', { cust_type : cust_type, branch_status : branch_status }, function(data){
	...
	function dynamic_customer_load(cust_type, company_name)
	{
	  ...
	  var base_url = $('#base_url').val();
	  var branch_status = $('#branch_status').val();
	    $.get(base_url+"view/visa_passport_ticket/train_ticket/home/get_customer_dropdown.php", { cust_type : cust_type , company_name : company_name, branch_status : branch_status}, function(data){
