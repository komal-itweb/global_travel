...
public function customer_master_save()
{
  ...
  $anni_date = $_POST['anni_date'];
  $cust_mail_opt = $_POST['cust_mail_opt'];
  ...
  $sq_visa = mysql_query("insert into customer_master (customer_id,type,first_name, middle_name, last_name, gender, birth_date, age, country_code,contact_no,landline_no, email_id,alt_email,company_name, address, address2, city, active_flag, created_at,service_tax_no,state_id,pan_no, branch_admin_id,source,anni_date, payment_date) values ('$customer_id','$cust_type', '$first_name', '$middle_name', '$last_name', '$gender', '$birth_date', '$age', '$country_code','$contact_no','$landline_no', '$email_id','$alt_email_id','$company_name', '$address','$address2','$city', '$active_flag', '$created_at', '$service_tax_no','$state','$cust_pan','$branch_admin_id','$cust_source','$anni_date','$payment_date')");
...
public function customer_master_update(){
  ...
  if($company_count>0){
	...
	$sq_visa = mysql_query("update customer_master set type = '$cust_type',first_name='$first_name', middle_name='$middle_name', last_name='$last_name', gender='$gender', birth_date='$birth_date', age='$age', country_code = '$country_code', contact_no='$contact_no',landline_no = '$landline_no', email_id='$email_id',alt_email = '$alt_email_id',company_name = '$company_name', address='$address', address2='$address2', city='$city', active_flag='$active_flag', service_tax_no='$service_tax_no1', state_id='$state', pan_no ='$cust_pan',source='$cust_source',anni_date='$anni_date', payment_date='$payment_date' where customer_id='$customer_id'");
