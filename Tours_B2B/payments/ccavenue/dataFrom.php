...
$sq_currency = mysql_fetch_assoc(mysql_query("SELECT currency_code FROM `currency_name_master` WHERE `id` = '$global_currency'"));
	...
	<form method="POST" name="customerData" action="ccavRequestHandler.php">
		<table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"><b>Integration Kit</b></font></caption></table>
			<table width="50%" height="100" border='1' align="center">
				...
				<tr>
					<td>Merchant Id	:</td><td><input type="text" name="merchant_id" value="255124"/></td>
				</tr>
				<tr>
					<td>Order Id	:</td><td><input type="text" name="order_id" value="<?php echo uniqid(); ?>"/></td>
				</tr>
				<tr>
					<td>Amount	:</td><td><input type="text" name="amount" value="<?php echo $payment_amount; ?>"/></td>
				</tr>
				<tr>
					<td>Currency	:</td><td><input type="text" name="currency" value="<?php echo $curr_code; ?>"/></td>
				</tr>
				<tr>
		        ...
		        <tr>
		        	<td>Billing Name	:</td><td><input type="text" name="billing_name" value="<?php echo $sq_customer['company_name'];?>"/></td>
		        </tr>
		        <tr>
		        	<td>Billing Address	:</td><td><input type="text" name="billing_address" value="<?php echo $sq_customer['address'];?>"/></td>
		        </tr>
		        <tr>
		        	<td>Billing Contact	:</td><td><input type="text" name="billing_tel" value="<?php echo $sq_customer['contact_no'];?>"/></td>
		        </tr>
		        <tr>
		        	<td>Billing Email	:</td><td><input type="text" name="billing_email" value="<?php echo $sq_customer['email_id'];?>"/></td>
		        </tr>
