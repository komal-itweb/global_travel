...
<section class="pageSection main_block">
  ...
  <?php
    traveling_info_second_page($sq_hotel_count, $sq_transport_count, $sq_plane_count,$quotation_id);
    traveling_info_first_page($sq_train_count, $sq_exc_count, $sq_cruise_count,$quotation_id);
  ?>
    </section>
    </section>
  <?php }
  ...
  <section class="pageSection main_block">
        ...
        <img src="<?= BASE_URL ?>images/quotation/p4/pageBG.jpg" class="img-responsive pageBGImg">
        <section class="travelingDetails main_block mg_tp_30 pageSectionInner">
        <?php  traveling_info_second_page($sq_hotel_count, $sq_transport_count, $sq_plane_count,$quotation_id);  ?>
...
<?php
function traveling_info_first_page($sq_train_count, $sq_exc_count, $sq_cruise_count,$quotation_id){
      if($sq_train_count>0){ ?>
...
<?php
function traveling_info_second_page($sq_hotel_count, $sq_transport_count, $sq_plane_count,$quotation_id){
