...
$(function () {
	$('#frm_tab_4').validate({
		...
		submitHandler: function (form) {
			...
			var plane_checked_programe_arr= new Array();
			...
			for (var i = 0; i < rowCount; i++) {
				...
				//if (row.cells[0].childNodes[0].checked) {
					var plane_checked_programe = row.cells[0].childNodes[0].checked;
					var travel_date_temp = row.cells[2].childNodes[0];
					var travel_date1 = $(travel_date_temp).val();
					...
					plane_checked_programe_arr.push(plane_checked_programe);
