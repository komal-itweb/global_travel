...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('C2', 'Excursion Summary')
...
$row_count = 11;
        ...
        $objPHPExcel->setActiveSheetIndex(0)
                ...
                ->setCellValue('C'.$row_count, "Excursion ID")
        ...
        while($row_exc = mysql_fetch_assoc($sq_exc)){
            ...
            $total_sale=$row_exc['exc_total_cost']+$sq_paid_amount['sumc'];
    	...
    	$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('I'.$row_count, number_format($row_exc['exc_issue_amount']+$sq_paid_amount['sumc'],2))
        ...
        ->setCellValue('O'.$row_count, 'TOTAL PAID : '.number_format($paid_total,2))
        ->setCellValue('P'.$row_count, 'TOTAL BALANCE :'.number_format($balance_total,2));
...
header('Content-Disposition: attachment;filename="ExcursionSummary('.date('d-m-Y H:i:s').').xls"');
