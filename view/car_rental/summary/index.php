 	...
 	<div class="row">
		...
		<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
			<select name="booking_id_filter" id="booking_id_filter" title="Booking ID" style="width: 100%">
		          <?php get_car_booking_dropdown($role, $branch_admin_id, $branch_status,$emp_id);   ?>
		    </select>
		</div>
		<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
...
function list_reflect()
{
	...
	$.post(base_url+'view/car_rental/summary/list_reflect.php', { customer_id : customer_id, booking_id : booking_id, from_date : from_date, to_date : to_date, cust_type : cust_type, company_name : company_name,booker_id:booker_id,branch_id : branch_id , branch_status : branch_status }, function(data){
...
list_reflect();
	...
	function excel_report()
	{
		...
		window.location = base_url+'view/car_rental/summary/excel_report.php?customer_id='+customer_id+'&booking_id='+booking_id+'&from_date='+from_date+'&to_date='+to_date+'&cust_type='+cust_type+'&company_name='+company_name+'&booker_id='+booker_id+'&branch_id='+branch_id+'&branch_status='+branch_status;
	}
	...
	function dynamic_customer_load(cust_type, company_name)
	{
	  var cust_type = $('#cust_type_filter').val();
 	  ...
 	  var branch_status = $('#branch_status').val();
      var base_url = $('#base_url').val();
	    $.get(base_url+"view/car_rental/booking/get_customer_dropdown.php", { cust_type : cust_type , company_name : company_name , branch_status : branch_status}, function(data){
	...
	{  
	    ...
	    var base_url = $('#base_url').val();
	    var branch_status = $('#branch_status').val();
	  	$.post(base_url+'view/car_rental/booking/company_name_load.php', { cust_type : cust_type  , branch_status : branch_status}, function(data){
