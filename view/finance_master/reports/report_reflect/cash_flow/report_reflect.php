	...
	<div class="col-md-8 col-md-offset-2 pl_sheet">
		<div class="panel panel-default main_block">
			...
			<!-- List Heading -->
				...
				$count_d =1;
				$head_count_d =1;
			 	$sq_group = mysql_query("select * from group_master where group_id='2' order by group_id desc");
				 //Groups
				...
				$count_d =1;
				$head_count_d =1;
			 	$sq_group = mysql_query("select * from group_master where group_id='20' order by group_id desc");
				 //Groups
				 while($row_group = mysql_fetch_assoc($sq_group))
				      { 
				      	$sq_subgroup = mysql_query("select * from subgroup_master where group_id='$row_group[group_id]'");
			...
			<!-- List Heading -->
				...
				$count_d =1;
				$head_count_d =1;
				      	$sq_subgroup = mysql_query("select * from subgroup_master where subgroup_id='105'");
