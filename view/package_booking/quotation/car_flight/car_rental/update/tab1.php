<form id="frm_tab11_c">
	...
	<div class="row">
	<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	      <input type="text" id="total_mini_km" name="total_mini_km"  placeholder="Total Mini Km" title="Total Mini Km" onchange=";validate_balance(this.id);" value="<?= $sq_quotation['total_mini_km']?>">
		</div>
		<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
	      <input type="text" id="total_max_km" name="total_max_km"  placeholder="Total Max Km" title="Total Max Km" onchange=";validate_balance(this.id);" value="<?= $sq_quotation['total_max_km']?>">
		</div>
		<div class="col-md-3 col-sm-6 col-xs-12 mg_bt_10">
...
<script>
$('#from_date,#to_date,#total_hr,#total_km,#total_max_km,#total_mini_km,#driver_allowance1,#permit1,#toll_parking1,#state_entry,#other_charges,#local_places_to_visit,#places_to_visit,#traveling_date1').hide();
...
function reflect_feilds1(){
	...
	if(type=='Local'){
		...
		$('#total_max_km,#total_mini_km,#driver_allowance1,#permit1,#toll_parking1,#state_entry,#other_charges,#places_to_visit,#traveling_date1').hide();
	}
	if(type=='Outstation'){
		$('#from_date,#to_date,#total_hr,#total_km,#local_places_to_visit').hide();
		$('#total_max_km,#total_mini_km,#driver_allowance1,#permit1,#toll_parking1,#state_entry,#other_charges,#places_to_visit,#traveling_date1').show();
	}
}reflect_feilds1();
