...
<div class="row mg_bt_10">
	...
	<div class="col-md-2">
		<input type="text"  id="night_halt"  name="night_halt" class="text-right form-control" placeholder="Night Halt" title="Night Halt" onchange="quotation_cost_calculate();validate_balance(this.id)" value="0.00"> 
	</div>
